...
@Service(Constants.GREATER_THAN_EQUAL_CONDITION)
public class GreaterThanEqualConditionConverter implements ConditionsConverter {

    private final ConverterHelperService converterHelperService;

    @Autowired
    public GreaterThanEqualConditionConverter(ConverterHelperService converterHelperService){
