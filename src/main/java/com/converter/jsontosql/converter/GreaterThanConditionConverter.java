...
@Service(Constants.GREATER_THAN_CONDITION)
public class GreaterThanConditionConverter implements ConditionsConverter {

    private final ConverterHelperService converterHelperService;

    @Autowired
    public GreaterThanConditionConverter(ConverterHelperService converterHelperService){
